...
wibox_sep = wibox.widget.textbox()
wibox_sep.markup = "<span color='red'><b> | </b></span> "
...
clientkeys = awful.util.table.join(
    ...
    awful.key({altkey, }, "r", function() volumecfg:up() end),
    awful.key({altkey, }, "l", function() volumecfg:down() end),
    awful.key({altkey, }, "m",        function() volumecfg:toggle() end)
)
